...
> **v7.0 核心判断：** 先锁定证据，再落位样段。本版把“看起来像场地”的表达拆成四个等级：公开已核事实、可复算指标、待现场调查、禁止推定。大钟寺已有一宗两地块成交记录，清河已有一段公共工程合同，沿线控规已有程序进展；但三处重点区官方 polygon 和合格现场观察仍未取得，样段继续保持 `HOLD`。

| 评审维度 | v7.0 的实质深化 | 核验入口 |
| --- | --- | --- |
...
| 实施可行性 | 清河公共工程合同和大钟寺两地块成交记录进入场地证据账本，与三个最小样段的责任、预算和回退边界对照 | `site-evidence-ledger.json`、`three-proof-blocks.json` |
| 公共利益 | 三条现场路线已定义观察点、时窗和隐私准入；合格观察仍为 0 条，不把桌面研判冒充参与式验证 | `field-survey-register.json` |
| 风险与表达 | 控规通过部门联合审查不等于获批，建设单位不等于权利人，两个地块的数据不外推至整个重点区 | 第 10 张展板、场地证据审计脚本 |
...
v7.0 不把三个重点区继续放大成未经核实的“大项目”，而是每处先完成一个最小样段：众智园“停机花园”以 60 米 × 14 米同意剖面为包络，保留 4 米无 AI 通行和围合低速测试；AI 原点“来源门诊”以可逆首层和前场承载纸面登记、人工申诉与可撤回来源记录；大钟寺“免账号会客厅”以无障碍到达、多语人工和端侧辅助建立站城公共界面。
